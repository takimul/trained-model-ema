...
url = f"[https://api.binance.com/api/v3/klines?symbol={symbol.upper()}&interval={interval}&limit={limit}](https://api.binance.com/api/v3/klines?symbol={symbol.upper%28%29}&interval={interval}&limit={limit})"
try:
r = requests.get(url, timeout=10)
r.raise_for_status()
return r.json()
